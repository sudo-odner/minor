        ...
        <div className="bg-[#e6f0ff] flex items-center justify-center min-h-screen p-4 font-sans">
            <div className="bg-white w-full max-w-md rounded-2xl shadow-xl p-8 sm:p-10 transition-all duration-300">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Создать аккаунт</h1>
                    <p className="text-gray-500 mt-2 text-sm">Присоединяйтесь к сообществу Minor</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1">Имя пользователя</label>
                        <input 
                            type="text" 
