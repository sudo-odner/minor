        ...
        <div className="bg-[#e6f0ff] flex items-center justify-center min-h-screen p-4 font-sans transition-colors duration-200">
            <div className="bg-white w-full max-w-md rounded-2xl shadow-xl p-8 sm:p-10 transition-all duration-300 border border-transparent">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800 tracking-tight transition-colors">Добро пожаловать</h1>
                    <p className="text-gray-500 mt-2 text-sm transition-colors">Войдите в свой аккаунт Minor</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1 ml-1">
                            <label className="block text-xs font-bold text-gray-500 uppercase transition-colors">Пароль</label>
                            <a href="#" className="text-xs font-semibold text-[#002FA7] hover:underline transition-colors">Забыли?</a>
                        </div>
                        <input 
                            type="password" 
                            placeholder="••••••••" 
